<?php
/**
 * This file contains the transactional emails endpoint for MailTrillApi PHP-SDK.
 *
...
/**
 * MailTrillApi_Endpoint_TransactionalEmails handles all the API calls for transactional emails.
 *
 * @author Muzammil Versiani <muzammil.versiani@mailtrill.com>
 ...
 * @since 1.0
 */
class MailTrillApi_Endpoint_TransactionalEmails extends MailTrillApi_Base
{
    /**
