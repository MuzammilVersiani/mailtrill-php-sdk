<?php
/**
 * This file contains the templates endpoint for MailTrillApi PHP-SDK.
 *
...
/**
 * MailTrillApi_Endpoint_Templates handles all the API calls for email templates.
 *
 * @author Muzammil Versiani <muzammil.versiani@mailtrill.com>
 ...
 * @since 1.0
 */
class MailTrillApi_Endpoint_Templates extends MailTrillApi_Base
{
    /**
