<?php
/**
 * This file contains the lists subscribers endpoint for MailTrillApi PHP-SDK.
 *
...
/**
 * MailTrillApi_Endpoint_ListSubscribers handles all the API calls for lists subscribers.
 *
 * @author Muzammil Versiani <muzammil.versiani@mailtrill.com>
 ...
 * @since 1.0
 */
class MailTrillApi_Endpoint_ListSubscribers extends MailTrillApi_Base
{
    /**
     ...
     * Please note that this is available only for mailtrill >= 1.3.6.2
     *
     * @param string $emailAddress
     * @return MailTrillApi_Http_Response
     */
