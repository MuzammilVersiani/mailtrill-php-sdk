<?php
/**
 * This file contains the MailTrillApi_Http_Response class used in the MailTrillApi PHP-SDK.
 *
...
/**
 * MailTrillApi_Http_Response is the class used to get the responses back from the API endpoints.
 *
 * @author Muzammil Versiani <muzammil.versiani@mailtrill.com>
 ...
 * @since 1.0
 */
class MailTrillApi_Http_Response extends MailTrillApi_Base
{
    /**
    ...
    /**
     * @var MailTrillApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var MailTrillApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var MailTrillApi_Params $body the body of the response.
     */
    public $body;
     ...
     * Contructor.
     * 
     * @param MailTrillApi_Http_Request $request
     */
    public function __construct(MailTrillApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new MailTrillApi_Params($params);
        }
