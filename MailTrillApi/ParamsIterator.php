...
/**
 * MailTrillApi_ParamsIterator implements an interator for {@link MailTrillApi_Params}.
 *
 * It allows MailTrillApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class MailTrillApi_ParamsIterator implements Iterator
{
	/**
