<?php
/**
 * This file contains the File cache class used in the MailTrillApi PHP-SDK.
 *
...
/**
 * MailTrillApi_Cache_File makes use of the file system in order to cache data.
 *
 * @author Muzammil Versiani <muzammil.versiani@mailtrill.com>
 ...
 * @since 1.0
 */
class MailTrillApi_Cache_File extends MailTrillApi_Cache_Abstract
{
    /**
     ...
     * @return MailTrillApi_Cache_File
     */
