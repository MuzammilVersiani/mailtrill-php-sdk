...
/**
 * MailTrillApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class MailTrillApi_Cache_Xcache extends MailTrillApi_Cache_Abstract
{
    /**
