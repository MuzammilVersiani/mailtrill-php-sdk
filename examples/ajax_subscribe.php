...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $endpoint   = new MailTrillApi_Endpoint_ListSubscribers();
    ...
    if ($response->itemAt('status') == 'success') {
        exit(MailTrillApi_Json::encode(array(
            'status'    => 'success',
...
<head>
    ...
    <script type="text/javascript" src="assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://www.mailtrill.com/favicon.ico" type="image/x-icon" />
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by MailTrill EMA.
